...
public class SpringSecurityConf extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		List<RoleResourcesVO> roleResourcesVOList = roleResourcesService.selectRoleResourcesInfoList();
		...
		for(RoleResourcesVO roleResourcesVO : roleResourcesVOList) {
			...
			.antMatchers(roleResourcesVO.getUrl()).hasAnyAuthority(roleResourcesVO.getUrl());
			//权限设置管理
		}

		http.authorizeRequests()	//放行以下url
